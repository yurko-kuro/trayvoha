...
Поточний реліз `v1.4.0` є історичним legacy-релізом зі старими назвами. Канонічний релізний цикл TrayVoha починається з версії `1.0.0` після завершення фінальної перевірки.
